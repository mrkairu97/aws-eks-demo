...
# Create kairu97 namespace
resource "kubernetes_namespace" "kairu97" {
  metadata {
    name = "kairu97"
  }
}

# Resource Quota for DR cluster
resource "kubernetes_resource_quota" "dr_quota" {
  count = var.is_dr_cluster ? 1 : 0
...
resource "aws_iam_role" "aws_load_balancer_controller" {
  name = "EKSLoadBalancerController-${var.aws_region}"
